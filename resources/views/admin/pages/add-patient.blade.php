...
@section('content')
    ...
    <!-- Single Form -->
    <form action="{{ route('admin.pages.add.patient') }}" method="post">
        @csrf
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="email" class="form-control" placeholder="Enter Patient Email" required>
                        </div>
                    </div>
                </div>
                <!-- Add other fields for the second section as needed -->
            </div>
